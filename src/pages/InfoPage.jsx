...
function InfoPage() {
  ...
  const handleSubmit = (event) => {
    ...
    const comment = data.get('comment') || 'Sin comentario adicional.'
    const subject = activeAlliance?.subject || 'Contacto desde TURICINE'
    const body = `Nombre: ${name}\nCorreo: ${email}\n\nComentario:\n${comment}`

    window.location.href = `mailto:hola@turicine.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
    closeForm()
  }
