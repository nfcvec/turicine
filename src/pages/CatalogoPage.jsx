    ...
    <main className="net-shell" id="catalogo">
      ...
      <section className="hero-net reveal-2" onClick={handleHeroClick}>
        ...
        <div className="hero-actions">
          ...
          <Link to="/info" className="cta info cta-link">
            Mas Info
          </Link>
        </div>

        <div className="hero-dots" role="tablist" aria-label="Seleccion de peliculas destacadas">
      ...
      <section className="venues-net reveal-3" id="sedes" ref={venuesRef}>
        <div className="section-content">
          ...
          <p className="section-subtitle">{featured.title} - Elige donde quieres verla</p>
          ...
          <div className="venues-grid">
            {venues.map((venue) => (
              ...
              >
                <div className="venue-icon">P</div>
                <h3>{venue.name}</h3>
        ...
        <section className="showtimes-net reveal-4" id="horarios" ref={showtimesRef}>
          <div className="section-content">
            ...
            <p className="section-subtitle">
              {featured.title} - {venues.find((venue) => venue.id === selectedVenue)?.name}
            </p>
